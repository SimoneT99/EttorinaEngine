#include "../AbstractControllerManager.hpp"
#include <map>
...
class ControllerManager : public AbstractControllerManager{
    ...
    public:
        ...
        virtual void set_axis(Enums::ControllerAxis axis, float value) override;

        virtual void press_button(Enums::ControllerButton button) override;
        virtual void release_button(Enums::ControllerButton button) override;
