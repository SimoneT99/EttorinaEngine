...
class IButtonManager{
    ...
    public:
        ...
        virtual void bind_button_event(ButtonType button, Enums::ButtonEvent event, std::unique_ptr<AbstractInputCommand> action) = 0;
        virtual void unbind_mouse_event(ButtonType button, Enums::ButtonEvent event) = 0;

        virtual void press_button(ButtonType button) = 0;
        virtual void release_button(ButtonType button) = 0;
