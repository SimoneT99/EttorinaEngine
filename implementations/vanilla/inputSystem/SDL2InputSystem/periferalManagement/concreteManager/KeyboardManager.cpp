...
void KeyboardManager::press_button(Enums::KeyButton button){
    this->keyboard_button_manager->press_button(button);
}

void KeyboardManager::release_button(Enums::KeyButton button){
    this->keyboard_button_manager->release_button(button);
}
